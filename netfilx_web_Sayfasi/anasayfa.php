...
<body>
    ...
    <!--Veritabanında Cekilcek Aksiyon Filimleri-->
     ...
     <div class="aksiyon_isim"><a href="tümaksiyonfilimleri.php"> Aksiyon Filmleri </a></div>
        <?php
            $vericek = $db->query("SELECT * FROM action_movie ORDER BY id ASC LIMIT 5 ", PDO::FETCH_ASSOC);
        ...
        ?>
                    <div class="aksiyon_alanı">
                        <div class="kapsam">
                            ...
                            <div class="socaial_icon" onclick=""><i class="fa-regular fa-thumbs-up"></i> <button class="socaial_icons"><i class="fa-solid fa-bookmark"></i></button> </div>
                            </div>
                        </div> 
                    </div>
            </div>
