...
<body>
    <div id="menuKapsama">
            ...
            <div class="menu">
                ...
                <a href="yakınzamanda.php">Yakın Zamanda Ekleneler</a>
    ...
    <!--Veritabanında Cekilcek Aksiyon Filimleri-->
     ...
     <div class="name"><a href="tümaksiyonfilimleri.php"> Dizi Filmleri </a></div>
        <?php
            $vericek = $db->query("SELECT * FROM adventure_movie ORDER BY id ASC LIMIT 5 ", PDO::FETCH_ASSOC);
